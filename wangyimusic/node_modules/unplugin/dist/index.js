...
function normalizeAbsolutePath(path2) {
  if ((0, import_path.isAbsolute)(path2))
    return (0, import_path.normalize)(path2);
  else
    return path2;
}
  ...
  return (userOptions) => {
    ...
    const setup = (plugin) => plugin.esbuild?.setup ?? ((pluginBuild) => {
      ...
      const context = {
        ...
        addWatchFile(id) {
          watchList.add(import_path3.default.resolve(id));
        },
        emitFile(emittedFile) {
          const outFileName = emittedFile.fileName || emittedFile.name;
          if (initialOptions.outdir && emittedFile.source && outFileName)
            import_fs.default.writeFileSync(import_path3.default.resolve(initialOptions.outdir, outFileName), emittedFile.source);
        },
        getWatchFiles() {
          return [...watchList];
        }
